...
**Phase 7 — Website builder**, full-page editor with preview (not live), page/row/widget colors, heading sizes, text links, and extra widgets (video, map, gallery, pricing, hours, countdown, social, call). Does not replace a connected existing website. Does not change Stripe checkout. Public groovgro.com homepage stays Coming soon.
...
- Website builder: visual GroovGro-hosted page at `/w/[org]` with a full-page editor, draft preview, colors, heading/link controls, row/column layouts, extra widgets, and photos fetched by GroovGro so other sites cannot block them
