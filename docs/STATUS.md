...
**Phase 7 — Website builder**, full-page editor with preview (not live), numbered starter layouts (white with dark grey text), a color wheel plus hex and swatches, and extra GroovGro pages (Home plus About or a service page). Publish per page. Home cannot be deleted. Does not replace a connected existing website. Does not change Stripe checkout. Public groovgro.com homepage stays Coming soon.
