...
- Website page checklist: Find pages lists what GroovGro can see on Next step and Website. Home, program, calendar, event, and public booking pages start checked. About, login, and legal stay unchecked. You can add a missing URL. Review connected data then reads only the checked pages. Business keeps Review connected data and names Next step to find pages. Event detail URLs sit under Calendar so they are not 40 separate boxes.
