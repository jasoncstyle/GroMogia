...
| **BOOKSgro** | QuickBooks questions from stored payment copies: categorize, reconcile questions, simple reports. | File taxes; send invoices/payments; move money; invent balances; SEO/marketing |
...
Pipe + store. Same desk token for every seat.
...
| BOOKSgro | `GET/POST /api/bots/books` |
