...
export function buildIntelligenceBrief(facts: IntelligenceFacts): IntelligenceBrief {
  ...
  if (
    ...
    recommendations.push({
      ...
      body: `Open SEO to read link suggestions and estimated schema types from pages GroovGro already read. ${internalLinkCount} suggested ${internalLinkCount === 1 ? "link" : "links"} and ${schemaFactCount} schema ${schemaFactCount === 1 ? "fact" : "facts"} are listed. GroovGro will not add links or schema to the live website.`,
