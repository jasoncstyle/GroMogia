        ...
        <>
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              ) : isSearchLoopNextStep(step.primary.title) && step.searchLoop ? (
                <>
                  <SearchLoopPanel
                    loop={step.searchLoop}
                    canManage={canManageSeo}
                    embed
                  />
                </>
