# GroMogia agent operating rules
...
- Develop GroMogia with Cursor Cloud Agents for substantial work.
...
- Current implementation phase is **Phase 2 first real business data**.
