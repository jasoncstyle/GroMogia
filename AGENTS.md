...
- Do not mark later expansion work as implemented. Phases Q–T (scoring, attribution, experiments, execute) stay planned until Jason asks. Do not turn on SERP lookup, GEO lookup, or CMS publish.
