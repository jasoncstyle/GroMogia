...
- Current implementation phase is **Phase 7 website builder** (visual GroovGro-hosted pages: templates, live preview, drag-to-reorder sections, SEO apply onto the builder). See [docs/STATUS.md](docs/STATUS.md).
