...
- Current implementation phase is **Phase 7 website builder** (SiteOrigin-style rows and columns on GroovGro-hosted pages, templates, live preview, SEO apply onto the builder). See [docs/STATUS.md](docs/STATUS.md).
